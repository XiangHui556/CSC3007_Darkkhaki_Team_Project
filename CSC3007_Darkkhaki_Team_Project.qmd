...
restaurants <- read_csv("updated_restaurant_list.csv") |>
...
plot_usmap(data = latest_year_data, values = "percentage_increase", color = "white", labels = TRUE) +
  scale_fill_continuous(low = "#fabb5c", high = "#a11902", na.value = "#f7cf92", name = "Percentage Increase", label = scales::comma) +
